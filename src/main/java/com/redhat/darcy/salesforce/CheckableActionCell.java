...
public class CheckableActionCell {
    private final Element actionsCell;
    private final Browser context;

    public CheckableActionCell(Locator actionsCell, Browser context) {
        this(context.find().element(actionsCell), context);
    }

    public CheckableActionCell(Element actionsCell, Browser context) {
    ...
    public CheckableActionCell check() {
        getCheckbox().check();
        return this;
    }

    public CheckableActionCell uncheck() {
        getCheckbox().uncheck();
        return this;
    }

    private Checkbox getCheckbox() {
        return context.find().checkbox(By.nested(actionsCell, By.name("ids")));
    }
}
